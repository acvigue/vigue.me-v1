...
export default function PostsList({ posts, search }: { posts: PostOrPage[], search: boolean }) {
  ...
  const filteredPosts = posts
    ...
    .filter((post) => {
      return (
        post.title.toLowerCase().includes(searchValue.toLowerCase()) || post.excerpt?.toLowerCase().includes(searchValue.toLowerCase())
      );
    });
