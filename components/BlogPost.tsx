        ...
        <div className="rounded group relative w-full">
          ...
          <div className="rounded">
            <div className="relative rounded w-full bg-cover bg-center">
              <SmartImage sizes="(min-width: 1024px) 25vw, (min-width: 640px) 40vw, 80vw" srcset={feature_image_srcset} alt='Feature Image' className='object-cover w-full h-56 rounded' />
            </div>
