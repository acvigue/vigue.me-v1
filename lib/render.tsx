...
export function GhostContent({ html }) {
  let h = html.replaceAll(
    `<input type="range" class="kg-video-volume-slider" max="100" value="100">`,
    `<input type="range" class="kg-video-volume-slider" max="100" defaultValue="100">`,
  );
  h = h.replaceAll(
    `<input type="range" class="kg-video-seek-slider" max="100" value="0">`,
    `<input type="range" class="kg-video-seek-slider" max="100" defaultValue="0">`,
  );
